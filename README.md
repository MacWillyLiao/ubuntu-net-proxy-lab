...
```
<img src="/images/fig2.png" alt="示意圖" width="500">

- 查看 ns1 的路由
```bash
sudo ip netns exec ns1 ip route
```
<img src="/images/fig3.png" alt="示意圖" width="500">
...
上述三個終端機視窗設置如下圖：
<img src="/images/fig4.png" alt="示意圖" width="500">
...
<img src="/images/fig5.png" alt="示意圖" width="500">
...
<img src="/images/fig6.png" alt="示意圖" width="500">
...
回傳 403（拒絕請求）。
<img src="/images/fig7.png" alt="示意圖" width="500">
...
示 NAT 沒有運作，右邊終端機有顯示 proxy 回傳的結果，被 proxy 擋下來了，
回傳 403（拒絕請求）。
<img src="/images/fig8.png" alt="示意圖" width="500">
